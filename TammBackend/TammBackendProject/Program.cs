...
using TammbusinessLayer.AdVerficationHistory;
...
using TammbusinessLayer.ClientsRatings;
...
using TammbusinessLayer.SearchingExpections;
...
namespace TammBackendProject
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IClientRatingCommands, ClientsRatingsCommandsServices>();
            builder.Services.AddScoped<IClientRatingQueries, ClientsRatingsQueriesServices>();
            builder.Services.AddScoped<ICoinQueries, CoinsQueriesServices>();
            builder.Services.AddScoped<ISearchingExpectionsCommands, SearchingExpectionsCommands>();
            builder.Services.AddScoped<ISearchingExpectionsQueries, SearchingExpectionsQueries>();
            builder.Services.AddScoped<IAdVerficationHistoriyQueries, AdsVerficationsHistoriesQueriesServices>();
